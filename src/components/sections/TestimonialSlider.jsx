...
export default function TestimonialSlider() {
  ...
  return (
    <motion.section
      className="relative py-8 md:py-16 bg-gray-50 overflow-hidden rounded-2xl"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, margin: "-50px" }}
      variants={containerVariants}
    >
      {/* Background Image - Only show on desktop */}
      <motion.div
      ...
      {/* Mobile: Background with testimonial images */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Mobile Layout: Single column with content over image */}
        <div className="lg:hidden">
          ...
          >
            <Swiper
              ...
              speed={600}
              loop={true}
              className="min-h-[400px] sm:min-h-[450px] flex items-center"
            >
              {testimonials.map((testimonial) => (
                <SwiperSlide key={testimonial.id}>
                  <motion.div
                  ...
                  >
                    ...
                    >
                      <svg
                        className="w-10 h-8 text-white/80"
                        viewBox="0 0 46 31"
                        fill="none"
                      >
                        <path
                    ...
                    {/* Testimonial Text */}
                    <motion.blockquote
                      className="text-lg text-white mb-8 leading-relaxed px-4"
                    ...
                    >
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        <motion.a
                          ...
                          className="font-semibold hover:text-white transition-colors inline-block"
            ...
            <div className="flex items-center justify-between mt-8">
              ...
              <div className="flex gap-3">
                <button
                  className="testimonial-prev p-3 rounded-full border border-white/50 hover:border-white transition-all hover:bg-white/10 backdrop-blur-sm"
                ...
                <button
                  className="testimonial-next p-3 rounded-full border border-white/50 hover:border-white hover:bg-white/10 transition-all backdrop-blur-sm"
        ...
        <div className="hidden lg:flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          {/* Testimonial Content */}
