...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 text-white transition-all duration-300 sticky top-0 left-0 right-0 z-50 shadow-lg">
        {/* Top Bar */}
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-4">
              ...
              <div className="lg:hidden">
                <NavbarMobileMenu mainMenu={mainMenu} logoSrc={logoSrc} />
              </div>
